                            ...
                            <div>
                                ...
                                <ul style="list-style-type: none ">
                                    <div style="display: flex;justify-content: center">
                                        <li class="page-item"><a style="text-decoration: none; margin-right: 10px;margin: auto;" href="RequestOfParent?page=${page-1==0?(1):(page-1)}" class="page-link">Previous</a></li>
                                            <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                            <li class="page-item"><a style="text-decoration: none; margin-right: 10px;margin: auto;" href="RequestOfParent?page=${i}" class="page-link">${i}</a></li>
                                            </c:forEach>
                                        <li class="page-item"><a style="text-decoration: none; margin-left: 10px;margin: auto;" href="RequestOfParent?xd=0&page=${page+1>num?(num):(page+1)}" class="page-link">Next</a></li>
                                    </div>
                                </ul>
                            </div>
                        </c:if>
