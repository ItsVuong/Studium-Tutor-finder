 ...
 * @author mim
 */
@WebServlet(name = "RequestOfParent", urlPatterns = {"/RequestOfParent"})
public class RequestOfParent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Models.Request> requestList = dao.getAllRequestByParent((int) session.getAttribute("userId"));
        ...
        request.getRequestDispatcher("RequestOfParent.jsp").forward(request, response);
    }
