 ...
 * @author HP
 */
@WebServlet(name = "UnactiveClass", urlPatterns = {"/UnactiveClass"})
public class UnactiveClass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean check = daoC.unactiveClass(idClass);
        if (!check) {
            request.setAttribute("msg", "Hong dc be oi,da co giao vien");
        }
...
//         request.setAttribute("test", idClass);
